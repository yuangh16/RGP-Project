...
%dYdtY_meta_logtpm1zscorelogistic_order
outdir = './outputs/test1/rgp_meta_dYdtYlogtpm1zscorelogistic_logtpm1zscorelogistic_exp20cel';
geneExprTFAdir = fullfile(outdir, 'processedGeneExpTFA');
mkdir(geneExprTFAdir)

normGeneExprFile = './inputs/geneExpression/rna_meta_logtpm1zscorelogistic_order.txt';
...
%dYdtYFile = './inputs/geneExpression/rgp_exp_zscorelogtpm1_order.txt';
targGeneFile = './inputs/targRegLists/targene_exp20c.txt';
potRegFile = './inputs/targRegLists/regulator_exp20c.txt';
...
% instabOutMat = './outputs/rgp_meta_logtpm1_coaces0p15_scanhoco5e-5ovlp/instabilities_targ0p05_SS50_lo3_bS5/prior_b_coaces0p15_scanhoco5e-5ovlp_bias100_TFmRNA'
% trnOutMat ='./outputs/rgp_meta_logtpm1_coaces0p15_scanhoco5e-5ovlp/networks_targ0p05_SS50_lo3_bS5/Network0p05_15tfsPerGene/prior_b_coaces0p15_scanhoco5e-5ovlp_bias100_TFmRNA'
% meanEdgesPerGene = 15;
% modSizes = 1:meanEdgesPerGene;
% r2OutMat = [instabOutMat '_r2pred'];
% 
