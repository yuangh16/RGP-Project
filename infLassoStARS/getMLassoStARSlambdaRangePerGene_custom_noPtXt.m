...
for res = 1:totResponses % can be a parfor loop
    ...
    for ss = 1:totSS
        ...
        currPreds = (predictorMat(predInds,subsamp)'); % nobs X nvars, removed zscore
        currResponses = (responseMat(res,subsamp)'); % nobs X 1, removed zscore
