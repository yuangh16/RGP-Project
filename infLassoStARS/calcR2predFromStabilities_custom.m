function calcR2predFromStabilities_custom(instabMat,stabilitiesMat,r2OutMat,modSizes)
...
%     disp(instabTitleInf)
    ...
    SSE_predMatMean(testInds,:) = (baseModelTest-repmat(meanTargGene,1,totTestConds))'.^2; %(xij-xi,train)^2
